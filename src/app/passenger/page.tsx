...
import { Home, MapPin, Mic, Search, Shield, User, Wallet } from "lucide-react";
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-gray-200">
      ...
      <Card className="absolute bottom-0 left-0 right-0 z-10 rounded-t-3xl border-t-4 border-primary/50 shadow-2xl">
        <div className="p-6 space-y-4">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="h-14 pl-10 text-lg border-2 focus-visible:ring-primary"
            />
        ...
        <CardFooter className="grid grid-cols-3 gap-1 border-t bg-gray-50 p-0">
             <Button variant="ghost" className="flex-col h-20 rounded-none">
